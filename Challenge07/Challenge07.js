...
const objLat = (obj) => {
    ...
    let inputs;
    let inputs=Object.values(obj);
     inputs[0]=inputs[0].charAt(0).toUpperCase()+ inputs[0].slice(1);
    inputs[1]=inputs[1].charAt(0).toUpperCase()+inputs[1].slice(1);

    return `my name is ${inputs[0]} ${inputs[1]} I am ${inputs[2]} YO, and I love ${inputs[3]}.`;
};
// -------------------------------------------------------------------------------------------------------
